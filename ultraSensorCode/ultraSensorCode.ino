/*
  ...
  Arduino Uno IR Remote Control Post
  https://accautomation.ca/arduino-uno-ir-remote-control-infrared/
  Video
  https://youtu.be/Z5DGV6zvE1M
*/
...
void loop() /****** LOOP: RUNS CONSTANTLY ******/
{
  ...
  delay(200); //Delay to ensure that a repeat is not issued for every button press
